...
const TravelForm = () => {
  ...
  const toggleLengthOfTrip = (length) => {
    if (lengthOfTrip.includes(length)) {
      setLengthOfTrip(lengthOfTrip.filter(item => item !== length));
    } else {
      setLengthOfTrip([...lengthOfTrip, length]);
    }
  };
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <Link href="/Itineraries" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Show Me My Itineraries!</Text>
            </TouchableOpacity>
          </Link>
        </ScrollView>
      )}
